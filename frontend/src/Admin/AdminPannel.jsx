...
import CreateCakeForm from "./componets/createProduct/CreateCakeForm";
import CreateFlowerForm from "./componets/createProduct/CreateFlowerForm";
import CreatePlantForm from "./componets/createProduct/CreatePlantForm";
...
const product= [
  {name: 'Cakes', path:'/admin/product/create/cake'},
  {name: 'Flower', path:'/admin/product/create/flower'},
  {name: 'Plants', path:'/admin/product/create/plant'},
]
      ...
      <Box sx={{ display: `${isLargeScreen ? "flex" : "block"}` }}>
        ...
        <Box className="adminContainer" component="main" sx={{ flexGrow: 1 }}>
          ...
          <Routes>
            ...
            <Route path="/product/create/cake" element={<CreateCakeForm/>}></Route>
            <Route path="/product/create/flower" element={<CreateFlowerForm/>}></Route>
            <Route path="/product/create/plant" element={<CreatePlantForm/>}></Route>
